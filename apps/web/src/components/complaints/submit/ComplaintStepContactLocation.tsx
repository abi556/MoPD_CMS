...
export function ComplaintStepContactLocation({
  ...
  return (
    ...
    >
      ...
      <div className="rounded-lg border border-primary-fixed-dim bg-brand-wash p-4">
        <div className="flex items-start">
          <input
            ...
            className="mt-1 h-4 w-4 cursor-pointer rounded border-border-standard text-primary focus:ring-primary"
          />
          <div className="ml-3">
            <label
              htmlFor="consent"
      ...
      <div className="flex flex-col-reverse items-center justify-between gap-4 border-t border-border-standard pt-6 md:flex-row md:gap-0">
